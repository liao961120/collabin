...
```{r tex, echo=FALSE, fig.cap="(ref:tex)", out.width="100%"}
...
knitr::include_graphics('https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/ViewsIceberg.svg/640px-ViewsIceberg.svg.png')
```
...
```{r md2html, echo=FALSE, fig.cap='Markdown 轉換成 HTML', out.width="100%"}
