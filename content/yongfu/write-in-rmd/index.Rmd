...
這篇文章並非 **R Markdown** 的介紹文[^intro-rmd]，而是一篇**企圖說服**讀者採用 **R Markdown** 作為寫作工具的文章。本文以 **R Markdown** 撰寫並使用 **blogdown** 生成網頁。[原始碼](https://github.com/Rbloggers/coBlogger/tree/master/content/yongfu/write-in-rmd)託管於 GitHub。
